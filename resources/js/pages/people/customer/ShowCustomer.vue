<template>
    <AppBar :mainTitle="$t('view')" :sub-title="$t('customer')" />
...
import AccCustomerTable from "./payments/AccCustomerTable.vue"
import { useI18n } from "vue-i18n";
import TransfarCustomertable from "./payments/TransfarCustomertable.vue";
