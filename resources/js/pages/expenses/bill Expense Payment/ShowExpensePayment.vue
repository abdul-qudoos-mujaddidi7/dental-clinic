<template>
    ...
    <div dir="rtl">
        <v-dialog
            ...
            width="55rem"
            v-model="ExpenseRepository.ShowExpensePayment"
            class="rtl-dialog"
        >
                        ...
                        <v-table>
                            ...
                            <tbody>
                                ...
                                <tr
                                    v-for="(
                                        payment, index
                                    ) in ExpenseRepository.billExpensesPayments"
                                    :key="index"
                                    class="text-left"
                                >
                                    <td>
...
const deleteItem = async (payment) => {
    await ExpenseRepository.DeleteBillExpensePayment(payment.id);
};
...
const editItem = async (payment) => {
    ...
    // console.log(ExpenseRepository.meterCyclePaymentId, id);
    // await ExpenseRepository.fetchMeterCyclePaymentForUpdate(id);
};
